...
(1, 1, 'Нейросети. В каких странах и в каких сферах они уже используются?', '2024-01-27'),
(2, 1, 'Зарождение искусственного интеллекта', '2023-02-01'),
...
(6, 2, 'Кэш пятого уровня в процессоре - новая разработка Intel', '2024-01-04'),
(7, 1, 'Смогут ли роботы заменить человека во всех сферах жизни? Разбор мифов и теорий.', '2024-03-21');
...
--
ALTER TABLE `author`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID автора', AUTO_INCREMENT=9;
...
--
ALTER TABLE `publications`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID публикации', AUTO_INCREMENT=8;
